export default function Hero() {
    return (
        <>
            <section id="heroSection" className="container-fluid min-vh-100 d-flex flex-column" style={{ backgroundColor: "#171321" }}>
                <div className="container" style={{ paddingTop: "150px" }}>
                    <div className="row align-items-start">
                                ...
                                <div className="carousel-inner">
                                    <div className="carousel-item active">
                                        <div className="card border-0 shadow-lg rounded-4 overflow-hidden">
                                            <img src="assets/Silksong_cover.webp" className="card-img" alt="..." />
                                            <div className="card-img-overlay d-flex align-items-end p-3"
                                                style={{ background: "linear-gradient(to top, rgba(0,0,0,0.7), transparent)" }}>
                                                <h5 className="card-title text-white">Hollow Knight: Silksong<span
                                                    className="ms-5"></span></h5>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="carousel-item">
                                        <div className="card border-0 shadow-lg rounded-4 overflow-hidden">
                                            <img src="assets/darksouls2.jpg" className="card-img" alt="..." />
                                                <div className="card-img-overlay d-flex align-items-end p-3"
                                                    style={{ background: "linear-gradient(to top, rgba(0,0,0,0.7), transparent)" }}>
                                                    <h5 className="card-title text-white">Dark Souls II<span className="ms-5"></span></h5>
                                                </div>
                                        </div>
                                    </div>
                                    <div className="carousel-item">
                                        <div className="card border-0 shadow-lg rounded-4 overflow-hidden">
                                            <img src="assets/skyrim.png" className="card-img" alt="..." />
                                                <div className="card-img-overlay d-flex align-items-end p-3"
                                                    style={{ background: "linear-gradient(to top, rgba(0,0,0,0.7), transparent)" }}>
                                                    <h5 className="card-title text-white">Skyrim<span className="ms-5"></span></h5>
                                                </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="col">
                            <h1 className="text-end text-light" style={{ fontSize: "80px" }}>Compra juegos<br />Digitales
                            </h1>
                            ...
                            <ul className="d-flex justify-content-end gap-4 pt-5" style={{ listStyle: "none", marginRight: "100px" }}>
                                <li>
                                ...
                                <li>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="white"
                                        className="bi bi-xbox" viewBox="0 0 16 16">
                                        <path
                                ...
                                <li>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="white"
                                        className="bi bi-nintendo-switch" viewBox="0 0 16 16">
                                        <path
                            ...
                            <div className="d-flex justify-content-end mt-5" style={{ marginRight: "110px" }}>
                                <a className="btn btn-danger btn-lg" href="#juegosHome">Ver juegos disponibles</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div id="exploraDiv" className="d-flex flex-column justify-content-center align-items-center mt-auto">
                    <h1 className="text-center text-white fs-2 mt-5">Explora nuestras mejores ofertas !<svg
                        xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="white" className="bi bi-tags-fill ms-3"
                        viewBox="0 0 16 16">
                        <path
