            ...
            <div className="col">
                <div className="card">
                    ...
                    <div className="card-body">
                        ...
                        <button onClick={() => addToCart(game)} className="btn w-100 text-white d-flex justify-content-center align-items-center gap-2" style={{ backgroundColor: "rgb(23, 19, 33)" }}>
